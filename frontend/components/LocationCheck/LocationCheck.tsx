...
export default function LocationCheck({ onLocationChange, className = '' }: LocationCheckProps) {
  const {
    error,
    canCheckout,
    maxDistance,
    ...
    case 'checking':
      return (
        <div className={`${wrapperClass} bg-blue-50 border-blue-400`}>
          ...
          <div>
            <p className="text-sm font-medium text-blue-800">Checking your location...</p>
    ...
    case 'outside_range':
      return (
        <div className={`${wrapperClass} bg-red-50 border-red-400`}>
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-red-800">Outside delivery area</p>
            <p className="text-sm text-red-600">
              You are {getDistanceText()} from our store. We only deliver within {maxDistance}km.
            </p>
          </div>
          <button
            onClick={recheckLocation}
    ...
    case 'error':
      return (
        <div className={`${wrapperClass} bg-yellow-50 border-yellow-400`}>
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-yellow-800">Unable to verify location</p>
    ...
    default:
      return (
        <div className={`${wrapperClass} bg-gray-50 border-gray-300`}>
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-gray-700">Location check required</p>
