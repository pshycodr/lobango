      ...
      `}
        ...
        `}
            >
                ...
                <div className="ml-2 hidden lg:block group-hover:translate-x-2 transition-transform duration-300">
                    <svg
                        className="w-4 h-4 text-[var(--gold-crayola)] opacity-70 group-hover:opacity-100"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                    >
