  ...
  return (
    <div className="flex flex-col items-center justify-center py-16">
      <div className="relative mb-6">
        ...
        <div
          className="absolute top-2 left-2 w-16 h-16 border-4 border-transparent border-t-[var(--gold-crayola)] rounded-full animate-spin"
      ...
      <div className="text-center">
        <div className="flex items-center justify-center space-x-1 mb-2">
          <span className="text-[var(--gold-crayola)] text-lg font-semibold animate-pulse">
            Fetching your order
          </span>
          <div className="flex space-x-1">
            <div className="w-1 h-1 bg-[var(--gold-crayola)] rounded-full animate-bounce"></div>
            <div
              className="w-1 h-1 bg-[var(--gold-crayola)] rounded-full animate-bounce"
