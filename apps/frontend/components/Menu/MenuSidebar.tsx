...
export function MenuSidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`z-40 w-72 overflow-y-auto border-r border-(--white-alpha-10) bg-(--eerie-black-1) shadow-xl lg:fixed lg:h-screen lg:w-80 ${
      ...
      >
        <div className="p-6 lg:p-8">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="mt-2 text-sm font-light text-(--quick-silver)">
              Menu
            </p>
