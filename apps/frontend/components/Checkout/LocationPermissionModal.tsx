...
export default function LocationPermissionModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xs sm:max-w-sm mx-auto rounded-2xl shadow-2xl overflow-hidden"
      ...
      >
        ...
        <div className="p-6">
          {!hasBeenDenied ? (
            <>
              <div className="text-center mb-5">
                ...
                >
                  We need your location to check delivery availability and
          ...
          <div className="mt-4 text-center">
            <p className="text-xs" style={{ color: "var(--quick-silver)" }}>
