...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 z-40 w-full border-b border-transparent text-white transition-all duration-250 ${isScrolled ? "border-(--black-alpha-15) bg-(--eerie-black-4)" : ""} ${isHidden ? "-translate-y-full delay-250" : ""} sm:top-[px] ${isScrolled ? "sm:top-0" : ""}`}
      >
